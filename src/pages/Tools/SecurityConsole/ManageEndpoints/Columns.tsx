...
export const columns = (
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="min-w-max">{row.getValue("api_name")}</div>
    ),
  },
  {
      ...
      return (
        <div className="flex items-center justify-center gap-2">
          ...
          >
            ...
            clickedRow?.api_endpoint_id === row.original.api_endpoint_id ? (
